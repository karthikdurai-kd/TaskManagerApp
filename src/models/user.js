...
//Setting Virtuals for getting tasks created by particular user
userSchema.virtual("tasksByUser", {
    ref: 'Tasks',
    localField: '_id',
    foreignField: 'owner'
})
...
//for performing some operations before deleting
/*userSchema.pre('remove', async function(next){
    console.log("came before deleting!!!");
    const user = this;
